...
public class KTableExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Create the KTable instance. Note, with the Materialized configuration object, you need to provide a name for
        // the KTable in order for it to be materialized.
        // It will use caching and will only emit the latest records for each key after a commit.
        KTable<String, String> firstKTable = builder
                .table(
                        inputTopic,
                        Materialized
                                .<String, String, KeyValueStore<Bytes, byte[]>>as("ktable-store")
                                // Add SerDes for the key and value on Materialized object
